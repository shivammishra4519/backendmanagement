...
const {sellDevice,viewDeviceList,filterData,viewAlldeviceSold,filterDataByDate,viewAllLoansByCustomerId,filterNotPaidEmi,sellDeviceManual}=require('../controler/sell-device')
